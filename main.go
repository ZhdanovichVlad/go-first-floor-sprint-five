...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	running_value := (CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * float64(r.Duration.Hours()*MinInHours)
...
func (w Walking) Calories() float64 {
	...
	meanSpeedPow2 := math.Pow(meanSpeed, 2)
	return ((CaloriesWeightMultiplier*w.Weight + (meanSpeedPow2/w.Height*CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()) * MinInHours)
}
